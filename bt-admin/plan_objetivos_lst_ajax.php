...
{
	$linkedit = '<a class="editar" href="plan_objetivos_am.php?planobjetivocod='.$fila["planobjetivocod"].'" title="Editar" id="editar_'.$fila['planobjetivocod'].'">&nbsp;</a>';
	$tipoactivacion = 5;
	$class = "desactivo";
...
	$linkdel = '<a class="eliminar" href="javascript:void(0)" onclick="Eliminar('.$fila['planobjetivocod'].')" title="Eliminar" >&nbsp;</a>';
