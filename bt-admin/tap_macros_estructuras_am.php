	...
	<div class="form">
		<form action="tap_macros_estructuras_am.php" method="post" name="formmacroestructura" id="formmacroestructura" >
			<div class="datosgenerales">
				...
				<div>
    				<input type="text"  name="estructuradesc"  id="estructuradesc" maxlength="80" class="full" value="<?php  echo  FuncionesPHPLocal::HtmlspecialcharsBigtree($estructuradesc,ENT_QUOTES)?>"/>
				</div>
				...
				<div class="clearboth brisa_vertical">&nbsp;</div>
				<div>
    				<input type="text"  name="estructuraclass"  id="estructuraclass" maxlength="80" class="full" value="<?php  echo  FuncionesPHPLocal::HtmlspecialcharsBigtree($estructuraclass,ENT_QUOTES)?>"/>
				</div>
				<div class="clearboth aire_menor">&nbsp;</div>      
				<div class="menubarra">
    				<ul>
			...
			<input type="hidden" value="<?php  echo $macrocod?>" name="macrocod" id="macrocod" />
            <input type="hidden" value="<?php  echo $estructuracod?>" name="estructuracod" id="estructuracod" />
		</form>
	</div>
</div>
