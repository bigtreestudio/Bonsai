        ...
        <ul class="accionesnoticia">
			...
			if (!$noticiaduplicada)
			{
                ...
                while ($fila = $conexion->ObtenerSiguienteRegistro($resultadoacciones)){
					...
					?>
                        <li> <a class="boton base" href="not_noticias_bajar_publicacion.php?<?php  echo $getbajar?>"  class="<?php  echo $class?>" id="<?php  echo $fila['noticiaestadocodfinal']?>" rel="<?php  echo $fila['noticiaworkflowcod']?>" ><?php  echo  FuncionesPHPLocal::HtmlspecialcharsBigtree($fila['noticiaaccion'],ENT_QUOTES);?></a></li>
                        <?php 
                    $i++;
                    $class = "middle";
                }
            ...
            <ul class="accionesnoticia">
                ...
                if (!$noticiaduplicada)
                {
                    ...
                    while ($fila = $conexion->ObtenerSiguienteRegistro($resultadoacciones)){
                     ...
                     if ($accioneliminar){?>
                        <li><a class="boton rojo"  href="not_noticias_eliminar.php?<?php  echo $geteliminar?>" onclick="if (!confirm('Esta seguro que desea eliminar la publicacion?')) return false;"><?php  echo  FuncionesPHPLocal::HtmlspecialcharsBigtree($nombrebotoneliminar,ENT_QUOTES);?></a></li>
                    <?php  }?>
                <?php  }?>
                <li><a  class="boton base" href="not_noticias.php">Volver</a></li>
            </ul>
